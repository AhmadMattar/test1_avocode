    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('general.Edit_customer')}}</h5>
            ...
            <div class="modal-body">
                <form class="mr-2" id="edit" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <input type="hidden" class="form-control" name="id" id="customer_id">
                    ...
                    <div class="row pt-4">
                        <div class="col-12">
                            ...
                            <img src="" width="150" height="150" id="customer-cover">
